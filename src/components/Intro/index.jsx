...
const index = () => {
    return (
        <section>
            <div className="intro-top pt-[167px] pb-[184px]">
                <div className="container">
                    <div className="flex">
                        <div>
                            ...
                            <button className="font-['SairaSemiBold'] border border-white rounded-[5px] px-[30px] py-[10px] text-[18px] tracking-[1px] text-white my-[79px]">Courses</button>

                            <div className="rounded-[7px] flex p-[10px] gap-x-[30px] bg-white w-fit">
                                ...
                                <span className="intro-search cursor-pointer flex gap-x-[12px] text-[15px] text-white font-['InterMedium'] py-[14px] px-[30px] rounded-[10px]"><Search /> Search</span>
                            </div>
                        </div>
                    </div>
                </div>
